import {Card, CardMedia, CardContent, CardActions, CardHeader, IconButton, Collapse} from '@mui/material';
import {Button, Stack, Typography, Box} from '@mui/material';

export const MovieScreeningsCard = ({cinemaName, screenings}) => {
...
export const MovieScreenings = ({movieScreenings}) => {
